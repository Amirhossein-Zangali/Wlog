...
if (isset($_POST['edit']) && $_POST['table'] == 'user' && $_POST['role'] == 'writer') {
    ...
    $result->update();
    header('location: ./writer.php?page=' . $_POST['table']);
}
...
if (isset($_GET['approve']) || isset($_GET['reject'])) {
    ...
    header('location: ./writer.php?page=comment');
}
...
if (isset($_GET['delete']) && isset($_GET['page'])) {
    if ($_GET['page'] == 'post') {
        ...
        $del_post->delete();
        header('location:./writer.php?page=post');
    }
            ...
            <div class="container-fluid">
                            ...
                            <div class="card card-widget widget-user">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 border-left">
                                            <div class="description-block">
                                                <h5 class="description-header">سطح دسترسی</h5>
                                                <span><?= $user->acc_lvl > 0 ? 'آزاد' : 'بسته' ?></span>
                                            </div>
                                            <!-- /.description-block -->
                                        </div>
                                        <!-- /.col -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input name="role" required type="hidden"
                                                   value="writer" class="form-control">
                                        </div>
                                        <div class="form-group">
                ...
                <?php else: ?>
                    <?php if ($page == 'post'): ?>
                        ...
                        $posts = Post::where('user_id', $_SESSION['user_id']);
                        ...
                        if ($order == 'like')
                            $posts = Post::leftJoin('post_likes', 'posts.id', '=', 'post_likes.post_id')->select('posts.*')->selectRaw('COUNT(post_likes.id) as like_count')->groupBy('posts.id')->where('posts.user_id', $_SESSION['user_id']);
                        else
                            $posts = Post::where('user_id', $_SESSION['user_id']);
                        //date
                        if ($date)
                        ...
                        $post_count = Post::where('user_id', $_SESSION['user_id']);
                        if (isset($_GET['word'])) {
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                <form method="get" class="input-group-append">
                                                    ...
                                                    <a href="./writer.php?page=post&add=" class="btn btn-primary"
                    ...
                    <?php elseif ($page == 'category' && $user->acc_lvl > 0): ?>
                        <?php
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools">
                                            <form method="get" class="input-group-append">
                                                <a href="./writer.php?page=category&add=" class="btn btn-primary"
                    ...
                    <?php elseif ($page == 'comment'): ?>
                        ...
                        $user_posts = Post::where('user_id', $_SESSION['user_id'])->get();
                        $user_post_id = [];
                        foreach ($user_posts as $post) {
                            $user_post_id[] = $post->id;
                        }

                        $comments = \Wlog\Model\Comment::whereIn('post_id', $user_post_id);
                        ...
                        $comment_count = \Wlog\Model\Comment::where('id', '!=', '0')->whereIn('post_id', $user_post_id);
                        if (isset($_GET['word'])) {
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    foreach ($comments as $index => $comment): ?>
                                                        <tr>
                                                            ...
                                                            <td><?= mb_substr($comment->content, 0, 20) . '...' ?></td>
