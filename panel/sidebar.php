        ...
        <div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="admin.php" class="nav-link <?= !isset($_GET['page']) ? 'active' : '' ?>">
                    ...
                    <li class="nav-item">
                        <a href="admin.php?page=post" class="nav-link <?= isset($page) && $page == 'post' ? 'active' : '' ?>">
                    ...
                    <li class="nav-item">
                        <a href="admin.php?page=category" class="nav-link <?= isset($page) && $page == 'category' ? 'active' : '' ?>">
                    ...
                    <li class="nav-item">
                        <a href="admin.php?page=comment" class="nav-link <?= isset($page) && $page == 'comment' ? 'active' : '' ?>">
