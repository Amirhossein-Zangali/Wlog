...
<div class="blog_main_wrapper">
    ...
    <div class="blog_banner_slider wrapper">
        <div class="swiper-container gallery-top" style="margin-top: 80px">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <?php $post = Post::orderBy('id', 'desc')->first(); ?>
                    <div class="blog_post_slider_wrapper">
                        <a href="single.php?id=<?= $post->id ?>" class="blog_post_slider_img">
                            <img width="100%" src="uploads/thumbnails/<?= $post->thumbnail ?>" alt="">
                        </a>
                        <div class="blog_post_slider_content" style="right: 80px">
                            <p><?= jdate('Y-m-d', strtotime($post->created_at)) ?></p>
                            ...
                            <ul class="blog_meta_tags">
                                <li><span class="blog_bg_blue"><svg xmlns="http://www.w3.org/2000/svg" width="12px"
                                                                    height="7px">
                                            ...
                                            </svg><?= ' ' . (Post::find($post->id))->view ?></span></li>
                                <li><span class="blog_bg_pink"><svg xmlns="http://www.w3.org/2000/svg" width="13px"
                                            ...
                                            </svg><?= ' ' . Comment::where('post_id', $post->id)->count() ?></span></li>
                                <li><span class="blog_bg_pink">
                                        <?= ' ' . Category::find($post->category_id)->name ?></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <?php foreach ($categories as $category):
                        if ($category->subcat_id == 0):?>
                            <div class="blog_sports blog_topheading_slider_nav" data-wow-duration="0.2s">
                                <a style="width: 100%" href="cat.php?id=<?= $category->id ?>">
                                    <div class="blog_main_heading_div wow fadeInUp">
                                        <div class="blog_heading_div">
                                            <h3 class="blog_bg_pink"><?= $category->name ?></h3>
                                        </div>
                                    </div>
                                </a>
                                <div class="tab-content">
                                    <div class="tab-pane fade show active tabslider wow fadeInUp" id="nav-sportall"
                                         role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="blog_sport_slider">
                                                    <div class="swiper-container">
                                                        <div class="swiper-wrapper">
                                                            <?php $posts = Post::where('category_id', $category->id)->limit(6)->get();
                                                            $sub_categories = Category::where('subcat_id', $category->id)->get();
                                                            foreach ($sub_categories as $sub_category) {
                                                                $posts = Post::whereIn('category_id', [$category->id, $sub_category->id])->limit(6)->get();
                                                            }
                                                                        ...
                                                                        <div class="blog_post_style2_content">
                                                                            ...
                                                                            <ul class="blog_meta_tags">
                                                                                <li><span class="blog_bg_blue"><svg
                                                                                                xmlns="http://www.w3.org/2000/svg" width="12px" height="7px"><path fill-rule="evenodd" fill="rgb(255, 255, 255)" d="M11.829,3.074 C11.732,2.948 9.422,-0.000 6.468,-0.000 C3.514,-0.000 1.203,2.948 1.106,3.074 C0.916,3.320 0.916,3.678 1.106,3.925 C1.203,4.050 3.514,6.999 6.468,6.999 C9.422,6.999 11.732,4.050 11.829,3.925 C12.020,3.678 12.020,3.320 11.829,3.074 ZM7.370,1.771 C7.569,1.651 7.846,1.788 7.989,2.077 C8.132,2.366 8.087,2.696 7.888,2.816 C7.689,2.936 7.412,2.799 7.269,2.510 C7.126,2.221 7.171,1.890 7.370,1.771 ZM6.468,5.930 C4.404,5.930 2.668,4.183 2.067,3.499 C2.473,3.037 3.397,2.091 4.589,1.525 C4.357,1.915 4.220,2.381 4.220,2.883 C4.220,4.251 5.227,5.360 6.468,5.360 C7.709,5.360 8.715,4.251 8.715,2.883 C8.715,2.381 8.579,1.915 8.346,1.525 C9.539,2.091 10.463,3.037 10.869,3.499 C10.268,4.184 8.531,5.930 6.468,5.930 Z"/>
                                                                                        </svg><?= ' ' . (Post::find($post->id))->view ?></span></li>
