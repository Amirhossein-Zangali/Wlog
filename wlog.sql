...
(6, 'اروپا', 2, '2024-08-07 07:11:11', '2024-08-07 07:11:11'),
(7, 'فوتبال', 3, '2024-08-07 07:11:34', '2024-08-07 07:11:34'),
...
(5, 1, 9, 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ است', 0, 1, '2024-08-08 10:39:51', '2024-08-08 10:39:51'),
(6, 1, 7, 'لورم ایپسوم متن ساختگی', 0, 1, '2024-08-09 11:21:22', '2024-08-09 11:21:22'),
(7, 1, 7, 'ممنون', 6, 1, '2024-08-09 11:22:09', '2024-08-09 11:22:09'),
(8, 1, 3, 'مرسی', 7, 1, '2024-08-09 11:59:21', '2024-08-09 11:59:21'),
(9, 1, 7, 'لورم ایپسوم', 7, 1, '2024-08-09 12:05:03', '2024-08-09 12:05:03'),
(10, 1, 7, 'صنعت چاپ و با استفاده از طراحان گرافیک است', 6, 1, '2024-08-09 12:05:47', '2024-08-09 12:05:47'),
(11, 1, 7, 'مجله در ستون و سطرآنچنان که لازم است', 10, 1, '2024-08-09 12:06:25', '2024-08-09 12:06:25'),
...
(1, 1, 'پیشرفت‌های جدید در هوش مصنوعی: از یادگیری عمیق تا کاربردهای عملی', 'ai_tech.png', 'هوش مصنوعی (AI) با سرعتی شگفت‌انگیز در حال پیشرفت است و این تکنولوژی روز به روز بیشتر در زندگی روزمره ما نقش ایفا می‌کند. از یادگیری عمیق (Deep Learning) گرفته تا کاربردهای عملی در پزشکی، خودروسازی، و حتی هنر، AI قابلیت‌های بی‌پایانی دارد. اخیراً، پیشرفت‌های جدیدی در زمینه هوش مصنوعی صورت گرفته که شامل بهبود الگوریتم‌های یادگیری عمیق و توسعه سیستم‌های هوش مصنوعی است که می‌توانند وظایف پیچیده‌تری را با دقت بیشتری انجام دهند. این پیشرفت‌ها نه تنها به بهبود کیفیت زندگی کمک می‌کنند، بلکه فرصت‌های شغلی جدیدی نیز ایجاد می‌کنند و صنایع مختلف را متحول می‌سازند.', 1, 75, '2024-08-07 09:26:16', '2024-08-10 11:12:51'),
(2, 1, 'رشد گردشگری پایدار: راهکارهایی برای محافظت از منابع طبیعی در سفر', 'env_travel.png', 'با افزایش آگاهی جهانی درباره تغییرات اقلیمی و اثرات منفی گردشگری بر محیط زیست، مفهوم گردشگری پایدار به یکی از مهم‌ترین موضوعات در صنعت سفر تبدیل شده است. هدف گردشگری پایدار این است که اثرات منفی گردشگری بر محیط زیست و فرهنگ‌های محلی را کاهش داده و در عین حال از منابع طبیعی و جوامع محلی حمایت کند. برخی از راهکارهای عملی برای دستیابی به این هدف شامل استفاده از حمل‌ونقل عمومی، اقامت در هتل‌های دوستدار محیط زیست، و حمایت از کسب‌وکارهای محلی است. این تغییرات نه تنها به حفاظت از منابع طبیعی کمک می‌کنند، بلکه تجربه‌ای معنادارتر و اصیل‌تر از مقصدهای گردشگری به مسافران ارائه می‌دهند.', 2, 3, '2024-08-07 09:30:29', '2024-08-09 16:51:33'),
(3, 1, 'موفقیت‌های درخشان تیم ملی والیبال ایران در مسابقات جهانی', 'walball_sport.png', 'تیم ملی والیبال ایران در مسابقات جهانی امسال توانست با عملکردی چشمگیر و انگیزه‌ای بالا، به موفقیت‌های بزرگی دست یابد. این تیم با ترکیبی از بازیکنان جوان و باتجربه، و با هدایت مربیان حرفه‌ای، توانست رقبا را یکی پس از دیگری پشت سر بگذارد. عملکرد برجسته بازیکنان در حمله، دفاع، و هماهنگی تیمی، همگی نقش مهمی در دستیابی به این موفقیت‌ها داشتند. این پیروزی‌ها نه تنها برای تیم و کشور افتخارآمیز است، بلکه انگیزه‌ای برای نسل‌های جوان‌تر و ورزشکاران آینده نیز خواهد بود.', 8, 2, '2024-08-07 09:35:54', '2024-08-09 16:51:27'),
(4, 1, 'تغذیه سالم: راهی برای بهبود کیفیت زندگی', 'hel_food.png', 'تغذیه سالم و متعادل نه تنها به بهبود سلامت جسمانی کمک می‌کند، بلکه می‌تواند کیفیت زندگی را بهبود بخشد و از بیماری‌های مزمن پیشگیری کند. متخصصان تغذیه توصیه می‌کنند که رژیم غذایی حاوی مقادیر مناسبی از میوه‌ها، سبزیجات، غلات کامل، پروتئین‌های سالم و چربی‌های مفید باشد. یکی از راه‌های ساده برای بهبود تغذیه، کاهش مصرف غذاهای فرآوری‌شده و افزایش مصرف غذاهای طبیعی و تازه است. همچنین، توجه به اندازه وعده‌ها و هیدراته نگه داشتن بدن با مصرف کافی آب نیز از اهمیت بالایی برخوردار است. با انتخاب‌های غذایی هوشمندانه، می‌توان انرژی و روحیه را بهبود بخشید و از زندگی سالم‌تری لذت برد.', 4, 4, '2024-08-07 09:39:37', '2024-08-09 21:17:39');
...
(5, 'امیر', 'profile.png', 'amir', '$2y$10$7CPHfxn5.x4gZBP9PoJl0.VEOZzTyRWQVnaSMy1cjKN1GvkL9D2iK', 'amir@gmail.com', 'admin', 0, '2024-08-06 18:27:03', '2024-08-06 18:27:03'),
...
(9, 'حمید', 'profile.png', 'hamid', '$2y$10$EKCos34BtA2TBmGo3NtMNut1iq1lXsSeh8y/LOr7r71UfblWxSJU6', 'hamid@gmail.com', 'user', 0, '2024-08-08 10:22:30', '2024-08-08 10:22:30'),
(10, 'احمد', 'profile.png', 'ahmad', '$2y$10$htMZOE5vgll72rouNjBNMe.AzM55EIeqqsoO1zuSuq6q.PoGbLyuS', 'ahmad@gmail.com', 'user', 0, '2024-08-09 20:00:06', '2024-08-09 20:00:06');
...
(19, 1, '127.0.0.1', '2024-08-08 16:56:13', '2024-08-10 11:12:51'),
